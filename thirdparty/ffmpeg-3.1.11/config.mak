...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-memalign-hack --enable-static --enable-gpl --enable-libx264 --extra-cflags=-I/usr/local/include --extra-ldflags=-L/usr/local/lib --enable-ffplay
prefix=/usr/local
...
CFLAGS=  -I/usr/local/include -std=c99 -fomit-frame-pointer -pthread -I/usr/local/include  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/usr/local/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lXv -lX11 -lXext -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -lsndio -lasound -L/usr/local/lib -lx264 -lm -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
